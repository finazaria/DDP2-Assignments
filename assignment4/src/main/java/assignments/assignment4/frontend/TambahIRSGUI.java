    ...
    public TambahIRSGUI(JFrame frame, ArrayList<Mahasiswa> daftarMahasiswa, ArrayList<MataKuliah> daftarMataKuliah){
        ...
        tambahkanBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // 2. Matkul pernah diambil sebelumnya
                // 3. Kapasitas penuh
                // 4. Maksimal ngambil 10 matkul
                // 5. Else : baru ditambahin
                ...
                if (selectedNPM == null || selectedMatkul == null) {                // Jika salah satu dari dropdown masih belum dipilih
                    ...
                    String pesan = mahasiswa.addMatkul(mataKuliah);      // Akan mereturn String format untuk message box
